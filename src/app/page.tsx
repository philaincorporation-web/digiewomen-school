...
import {
  stats,
  formations,
  temoignagesApprenants,
  temoignagesEntreprises,
} from "@/data/content";
import {
  staggerContainer,
  staggerItem,
...
export default function HomePage() {
  ...
  return (
    <>
      <HeroCarousel />
      {/* Legacy hero retained temporarily for reference.
      <section className="relative overflow-hidden bg-gradient-to-br from-digie-blue via-digie-purple to-digie-green text-white">
        <div className="absolute inset-0 opacity-10">
          <motion.div
            variants={parallax}
            initial="hidden"
            animate="visible"
            className="absolute -top-20 -right-20 w-[600px] h-[600px] rounded-full bg-white/20 blur-3xl"
          />
          <motion.div
            variants={parallax}
            initial="hidden"
            ...
            className="absolute -bottom-20 -left-20 w-[400px] h-[400px] rounded-full bg-digie-green/20 blur-3xl"
          />
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 relative">
          ...
          >
            <motion.span variants={heroBadge} initial="hidden" animate="visible" className="inline-block px-4 py-1.5 rounded-full bg-white/20 text-sm font-medium mb-6 backdrop-blur-sm">
              Formation Numérique & Agro-Pastorale
            </motion.span>

            <motion.h1 variants={heroTitle} initial="hidden" animate="visible" className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              Formez-vous aux métiers d&apos;avenir avec{" "}
              <span className="text-digie-green-light">DigieWomen School</span>
            </motion.h1>

            <motion.p variants={heroDescription} initial="hidden" animate="visible" className="text-lg md:text-xl text-white/90 mb-8 leading-relaxed">
              Depuis 2018, nous accompagnons les femmes, les jeunes et les organisations
              dans leur transformation digitale et le développement agro-pastoral au Gabon et à l&apos;international.
            </motion.p>

            <motion.div variants={heroCTA} initial="hidden" animate="visible" className="flex flex-wrap gap-4">
              <Link
                href="/formations"
              ...
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white/20 backdrop-blur-sm text-white font-semibold hover:bg-white/30 transition-all hover:scale-105 active:scale-95"
              >
                Nous contacter
              </Link>
            </motion.div>
    ...
    <div className="grid md:grid-cols-2 gap-10 items-center">
      ...
      <section className="py-16 md:py-24 bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <TestimonialCarousel
              apprenants={temoignagesApprenants}
              entreprises={temoignagesEntreprises}
            />
          </motion.div>
        </div>
      </section>
